 ...
 */
$config['site_title']                 = "iDream Nigeria";       // Site Title, example.com
$config['admin_email']                = "admin@new.successpower.org"; // Admin Email, admin@example.com
...
$config['lockout_time']               = 1800;                // The number of seconds to lockout an account due to exceeded attempts
$config['forgot_password_expiration'] = 86400000;                   // The number of miliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
